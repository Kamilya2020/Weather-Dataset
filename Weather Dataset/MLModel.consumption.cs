...
namespace Weather_Dataset
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Temperature (C)_LB")]
            public float[] Temperature__C__LB { get; set; }

            [ColumnName(@"Temperature (C)_UB")]
            public float[] Temperature__C__UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Projects\Weather Dataset\Weather Dataset\MLModel.zip");
